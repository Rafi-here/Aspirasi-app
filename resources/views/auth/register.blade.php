    ...
    <div class="min-h-screen flex items-center justify-center p-4 blue-pastel-bg relative overflow-hidden">
        <div class="w-full max-w-md mx-auto relative z-10">
            ...
            <div class="text-center mb-8 animate-fade-in">
                ...
                <p class="blue-pastel-text-secondary">Buat Akun Baru</p>
            </div>
            ...
            <div class="blue-pastel-card rounded-3xl p-8 animate-fade-in" style="animation-delay: 0.2s;">
                <div class="text-center mb-6">
                    <h2 class="text-2xl font-semibold blue-pastel-text mb-2">Bergabung dengan Kami</h2>
                    <p class="blue-pastel-text-muted text-sm">Isi data berikut untuk membuat akun baru</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <!-- Name Field -->
                    <div class="space-y-2">
                        <label for="name" class="text-sm font-medium blue-pastel-text flex items-center">
                        ...
                        <div class="relative">
                            <input id="name" class="blue-pastel-input w-full pl-10 pr-4 py-3 rounded-xl"
                    ...
                    <div class="space-y-2">
                        <label for="password_confirmation"
                            class="text-sm font-medium blue-pastel-text flex items-center">
                            <svg class="w-4 h-4 mr-2 input-icon" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="relative">
                            <input id="password_confirmation"
                                class="blue-pastel-input w-full pl-10 pr-10 py-3 rounded-xl" type="password"
                            ...
                            <button type="button" onclick="togglePassword('password_confirmation')"
                                class="absolute right-3 top-1/2 transform -translate-y-1/2 input-icon hover:text-blue-600">
                                <svg id="eye-icon-password_confirmation" class="w-5 h-5" fill="none"
                    ...
                    <!-- Submit Button -->
                    <button type="submit"
                        class="blue-pastel-button w-full py-3 rounded-xl font-medium relative overflow-hidden group mt-6">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-white blue-pastel-text-muted">Sudah punya akun?</span>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        <p class="text-sm blue-pastel-text-muted">
                            Sudah terdaftar?
                            <a href="{{ route('login') }}" class="font-medium blue-link ml-1">
                                Masuk di sini
                            </a>
                        </p>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('mousemove', function(e) {
            ...
            blobs.forEach((blob, index) => {
                ...
                const moveX = Math.min(Math.max((x - 0.5) * 30 * speed, -10), 10);
                const moveY = Math.min(Math.max((y - 0.5) * 30 * speed, -10), 10);
